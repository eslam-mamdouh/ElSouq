  ...
  <header class="main-header">
    ...
    <nav class="navbar navbar-static-top">
      <!-- Sidebar toggle button-->
        ...
        <i class="fa fa-bars sidebar-toggle" data-toggle="push-menu" role="button"></i>
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="hidden-xs">Elwad El Admin</span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="/orders"><i class="fa fa-circle-o"></i>All Orders</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
...
<script src="datatables.net-bs/js/jquery.dataTables.js"></script>
